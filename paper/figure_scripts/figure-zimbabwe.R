...
dt_marginal <- readRDS("~/bayes-rate-consistency-output/results/hsgp-m52-rd-zimbabwe-single-age/intensity_marginal.rds")
...
dt_marginal_stratified <- readRDS("~/bayes-rate-consistency-output/results/hsgp-m52-rd-zimbabwe-stratified-age/intensity_marginal.rds")
