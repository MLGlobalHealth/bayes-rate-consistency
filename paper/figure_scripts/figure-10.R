...
dt <- readRDS("~/bayes-rate-consistency-output/results/hsgp-m52-lrd_COVIMOD_multi_1234/intensity_sliced.rds")
...
ggsave("~/bayes-rate-consistency/paper/figures/figure-10.tiff",
