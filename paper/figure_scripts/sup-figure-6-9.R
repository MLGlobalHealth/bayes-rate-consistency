...
ggsave("~/bayes-rate-consistency/paper/figures/sup-figure-6.jpeg", width = 19, height = 15.5, units = "cm")

# Wave 3
plot_empricial(3) / plot_socialmixr(3) / plot_gp(3) + plot_layout(nrow = 3)
ggsave("~/bayes-rate-consistency/paper/figures/sup-figure-7.jpeg", width = 19, height = 15.5, units = "cm")

# Wave 4
plot_empricial(4) / plot_socialmixr(4) / plot_gp(4) + plot_layout(nrow = 3)
ggsave("~/bayes-rate-consistency/paper/figures/sup-figure-8.jpeg", width = 19, height = 15.5, units = "cm")
