...
transformed parameters
{
  ...
  f_MM = gp2d(age_idx_std, age_idx_std, gp_alpha[MM], gp_rho_1[MM], gp_rho_2[MM], z[1:A,]);
  f_FF = gp2d(age_idx_std, age_idx_std, gp_alpha[FF], gp_rho_1[FF], gp_rho_2[FF], z[(A+1):2*A,]);
  f_MF = gp2d(age_idx_std, age_idx_std, gp_alpha[MF], gp_rho_1[MF], gp_rho_2[MF], z[(2*A+1):3*A,]);
