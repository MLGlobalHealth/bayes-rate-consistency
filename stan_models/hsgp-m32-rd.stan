...
transformed parameters
{
  ...
  f_MM = hsgp_matern32_restruct(A, gp_alpha[MM], gp_rho_1[MM], gp_rho_2[MM],
                                L1, L2, M1, M2, PHI1, PHI2,
                                z[1:M1,], NN_IDX);
  f_FF = hsgp_matern32_restruct(A, gp_alpha[FF], gp_rho_1[FF], gp_rho_2[FF],
                                L1, L2, M1, M2, PHI1, PHI2,
                                z[(M1+1):2*M1,], NN_IDX);
  f_MF = hsgp_matern32_restruct(A, gp_alpha[MF], gp_rho_1[MF], gp_rho_2[MF],
                                L1, L2, M1, M2, PHI1, PHI2,
