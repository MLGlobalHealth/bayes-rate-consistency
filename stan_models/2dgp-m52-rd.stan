...
transformed parameters
{
  ...
  f_MM = gp2d_matern52_restruct(diff_idx_std, age_idx_std, gp_alpha[MM], gp_rho_1[MM], gp_rho_2[MM], z[1:D,], NN_IDX);
  f_FF = gp2d_matern52_restruct(diff_idx_std, age_idx_std, gp_alpha[FF], gp_rho_1[FF], gp_rho_2[FF], z[D+1:2*D,], NN_IDX);
  f_MF = gp2d_matern52_restruct(diff_idx_std, age_idx_std, gp_alpha[MF], gp_rho_1[MF], gp_rho_2[MF], z[2*D+1:3*D,], NN_IDX);
